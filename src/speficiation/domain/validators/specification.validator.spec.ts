import SpecificationValidatorFactory from './specification.validator';

describe('SpecificationValidator Tests', () => {
  let validator: SpecificationValidatorFactory;

  beforeEach(() => (validator = SpecificationValidatorFactory.create()));
