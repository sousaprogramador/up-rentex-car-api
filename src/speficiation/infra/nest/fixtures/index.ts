...
export class CreateSpecificationFixture {
  static keysInResponse() {
    return SpecificationFixture.keysInResponse();
  }

  static arrangeForSave() {
    return SpecificationFixture.arrangeForSave();
  }

  static arrangeInvalidRequest() {
    return SpecificationFixture.arrangeInvalidRequest();
  }

  static arrangeForEntityValidationError() {
    return SpecificationFixture.arrangeForEntityValidationError();
  }
}

export class UpdateSpecificationFixture {
  static keysInResponse() {
    return SpecificationFixture.keysInResponse();
  }
...
export class ListSpecificationsFixture {
  static arrangeIncrementedWithCreatedAt() {
    const _entities = Specification.fake()
      .theSpecifications(4)
      .withName((i) => i + '')
