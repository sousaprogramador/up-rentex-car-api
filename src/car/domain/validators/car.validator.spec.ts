import CarValidatorFactory from './car.validator';

describe('CarValidatorFactory Tests', () => {
  let validator: CarValidatorFactory;

  beforeEach(() => (validator = CarValidatorFactory.create()));
